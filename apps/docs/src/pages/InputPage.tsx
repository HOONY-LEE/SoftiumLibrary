...
const propRows = [
  ...
  { name: "helperText", type: "string", description: "input 아래에 표시되는 도움말 텍스트" },
  ...
  return (
    <div>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 32, fontWeight: 700, color: "#212121", marginBottom: 8 }}>Input</h1>
      ...
      <Section title="Helper Text & Error">
        <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
          ...
          <Input label="에러" placeholder="입력하세요" error errorMessage="올바르지 않은 값입니다." value="invalid@" />
        </div>
      </Section>
